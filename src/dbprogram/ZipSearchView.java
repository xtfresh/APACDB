 ...
 * @author Montek
 */
public class ZipSearchView extends javax.swing.JFrame {
    Connection con;
    private String zip;
    /**
     * Creates new form ZipSearchView
     */
    public ZipSearchView(Connection conn, String zip) {
        this.zip = zip;
        con = conn;
        initComponents();
    }
    public ZipSearchView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Address", "Zip", "Phone", "Hours Open", "DaysOpen"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZipSearchView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZipSearchView().setVisible(true);
            }
        });
    }
